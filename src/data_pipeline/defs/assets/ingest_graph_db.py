...
def load_graph_db(
    context: AssetExecutionContext, config: Neo4jConfig
) -> MaterializeResult:
    """
    Dagster asset that ingests music data into the Neo4j database efficiently.
    ...
    """
    driver: Driver = get_neo4j_driver(config)
